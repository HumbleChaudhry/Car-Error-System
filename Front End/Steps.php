  ...
  <body>
    ...
    <div id="banner">
      <div id="parts-container">
        ...
        <h1 class="form__title">Steps</h1>

        <table class="table table-striped">
    <tr  class="bg-warning">
        <th   data-colname="number" data-order="desc">Number </th>
        <th   data-colname="title" data-order="desc">Title </th>
...
var myArray = JSON.parse(localStorage.getItem('mySteps'));
